...
class Signup3 extends Component {
  ...
  getUserInfo = async e => {
    ...
    // alert( "Attempted to get user info of " + localStorage.getItem("username"));
      ...
      this.setState({ birthday: userInfo.birt_date });
    ...
    return (
      ...
      <div>
        <div className="ui segment">
          ...
          <div className="ui two column centered grid segment">
            <div className="row">
            ...
            <form className="ui form" onSubmit={this.handleSubmit}>
              ...
              <div className="fields">
                ...
                <div className="field">
                  ...
                  <select multiple="" className="ui dropdown"
                  defaultValue={this.state.civilstatus}
                ...
                <div className="field">
                  ...
                  <select multiple="" className="ui dropdown"
                  defaultValue={this.state.yearlevel}
              ...
              <h4 className="ui dividing header">For Insurance Purposes</h4>
              ...
              <h4 className="ui dividing header">Contact Person in Case of Emergency</h4>
              ...
              <div className='field'>
                <button type="submit" className="ui button">Confirm Edit</button>
              </div>
